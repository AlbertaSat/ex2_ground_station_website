...
Revision ID: f04b39393b20
Revises: 
Create Date: 2022-06-26 09:22:01.909498
...
def upgrade():
    ...
    sa.Column('automatedcommand_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['automatedcommand_id'], ['automatedcommands.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
