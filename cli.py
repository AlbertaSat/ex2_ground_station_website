...
def print_hk():
    ...
    # print(hk)
    print("STATUS (as of {}){:>12} mode".format(
        hk["last_beacon_time"], hk["satellite_mode"].upper()))
    print("{} MCU resets.".format(hk["no_MCU_resets"]))
    print("Battery {:>10}v{:>10} IN{:>10} OUT".format(
        hk["battery_voltage"], hk["current_in"], hk["current_out"]))
    print("Watchdogs{:>10}{:>9}{:>12}".format(
        hk["watchdog_1"], hk["watchdog_2"], hk["watchdog_3"]))
    print("Panels{:>12}{:>11}{:>13}\n{:>18}{:>11}{:>13}".format(
        hk["panel_1_current"], hk["panel_2_current"], hk["panel_3_current"], hk["panel_4_current"], hk["panel_5_current"], hk["panel_6_current"]))
    print("Temps.{:>12}{:>11}{:>13}\n{:>18}{:>11}{:>13}".format(
        hk["temp_1"], hk["temp_2"], hk["temp_3"], hk["temp_4"], hk["temp_5"], hk["temp_6"]))
    print("Power Chnls. {:>5}{:>11}{:>13}".format("#", "enabled", "current"))
    for channel in hk["channels"]:
        print("{:>18}{:>11}{:>13}".format(
            channel["channel_no"], channel["enabled"], channel["current"]))
