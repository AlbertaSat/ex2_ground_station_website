...
def add_telecommand(command_name, num_arguments, is_dangerous, about_info):
    ...
    if not command:
        command = Telecommands(command_name=command_name, num_arguments=num_arguments, is_dangerous=is_dangerous, about_info=about_info)
