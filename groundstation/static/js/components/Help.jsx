      ...
      <div>
        ...
        >
          ...
          >
            ...
            and green means that the flight schedule has already been uploaded
            to the satellite.
            <Paper
              style={{
                marginLeft: '20px',
            ...
            Only one flight schedule may be queued at a time and a queued
            schedule will be automatically uploaded to the satellite during the
            next passover. It is also possible to upload a schedule manually via
            the live commands.
          </Typography>
          <Typography
            variant="body1"
          ...
          >
            ...
            time in the execution time box:
            ...
            Then, you fill in the relevant arguments based on the command and
            set a delta time in the "Delta Time" field:
            <form>
              <TextField
                id="outlined-basic"
                label="Delta Time"
            ...
            The delta time is an offset from the scheduled time in seconds. This
            means the command will execute x seconds after the scheduled time.
        ...
        <Paper className="Housekeeping" style={{ marginBottom: '20px' }}>
          ...
          >
            ...
            Each housekeeping log contains information about the satellite, such
            as the watchdog timers, as well as voltages. A housekeeping file
            with a green tag means that the housekeeping log is healthy and
            detected no issues,
            <Paper
              style={{
                marginLeft: '20px',
        ...
        <Paper className="Live Commands" style={{ marginBottom: '20px' }}>
          ...
          >
            ...
            The Live Commands page displays any messages sent to or received
            from the satellite communications module. Note that the live
            commands window will only display the commands for the duration you
            are on the page. To view a complete history of the communications
            with the satellite, go to the Logs page. The messages will be from
            one of a username (i.e. a human operator), the satellite ("comm"),
            or sent as part of an automated script ("automation").
          </Typography>
        </Paper>
        <Paper
        ...
        >
          ...
          >
            ...
            automated command sequence: a list of commands that will
            automatically be sent to the satellite upon the start of a passover.
            Only admin users have the ability to update the sequence. Commands
            can be added, removed, and their order in the sequence updated using
        ...
        <Paper className="Logs" style={{ marginBottom: '20px' }}>
          ...
          >
            ...
            satellite. To update the page, press the Refresh button. All
            messages will be denoted as from one of a username (i.e. a human
            operator), the satellite ("comm"), or sent as part of an automated
            script ("automation"). If a message is queued, it will be sent to
            the satellite during its next passover. Admin users can also
            de-queue messages before they are sent, and re-queue messages after
            they are sent. Non-admin users can also do so, but only for commands
            they have issued.
          </Typography>
        </Paper>
        <Paper className="Timer" style={{ marginBottom: '20px' }}>
          ...
          >
            ...
            signifying how much time has elapsed during the current passover.
            Once a passover ends, the timer will turn yellow again and begin
            counting down until the next passover.
          </Typography>
        </Paper>
        ...
        <Paper className="Manage Users">
          ...
          >
            Using the dropdown from the profile icon, admin users can register
            new users, as well as manage the users that they have registered.
            Note that admin users cannot be deleted, even by the admin user that
            created them.
          </Typography>
        </Paper>
      </div>
